    ...
    const CompensationForm = () => {
        ...
        return (
            <React.Fragment>
                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} sm={6}>
                        <TextField error={Errors['AnnualSalary']} required id="JobDesignation" name="AnnualSalary" label="Annual Salary" fullWidth helperText="excluding other benefits and perks, write in numerical and lakhs per annum" autoComplete="on" variant="standard" onChange={handleRequiredChange}
                        />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <TextField error={Errors['TotalEmolument']} required id="Total Emolument" name="TotalEmolument" label="Total Emolument" fullWidth helperText="CTC including all the benefits write in numerical and lakhs per annum" autoComplete="on" variant="standard" onChange={handleRequiredChange}
                        />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <TextField id="Joining Bonus" name="JoiningBonus" label="Joining Bonus" fullWidth autoComplete="on" variant="standard" onChange={handleChange}
                        />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                        <TextField id="Relocation Bonus" name="RelocationBonus" label="Relocation Bonus" fullWidth autoComplete="on" variant="standard" onChange={handleChange}
                        />
                    </Grid>
                    <Grid item xs={12}>
                        <TextField id="Other Benefits" name="OtherBenefits" label="Other Benefits" fullWidth autoComplete="on" variant="standard" onChange={handleChange}
                        />
                    </Grid>
                    <Grid item xs={12}>
                        <TextField id="Agreement Bond" name="AgreementBond" label="Agreement Bond" fullWidth autoComplete="on" variant="standard" helperText="Mention if any, else NA" onChange={handleChange}
                        />
                    </Grid>
